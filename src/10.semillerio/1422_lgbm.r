...
# Recomendacion gcp: 
#   This instance has had high CPU utilization recently. 
#   Consider switching to the machine type: n2-highmem-32 (32 vCPUs, 256 GB memory).
...
kexperimento  <- 5048 #NA si se corre la primera vez, un valor concreto si es para continuar procesando

kscript       <- "1422_lgbm"

karchivo_dataset   <-  "./datasets/dataset_epic_v1053.csv.gz"
...
# Semillas que elegí: 
#   135221, 355847, 646577, 772921, 975257
ksemilla_azar  <- 646577 
#------------------------------------------------------------------------------
