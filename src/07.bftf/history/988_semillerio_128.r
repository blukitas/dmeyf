...
param_ganadores  <- list( "learning_rate"=0.041850937045058, 
                          "feature_fraction"=0.518827404172165,
                          "bagging_fraction"=0.9492251881,
                          "bagging_freq"=70,
                          "min_gain_to_split"=4.1624566653172400,
                          "min_data_in_leaf"=32,
                          "num_leaves"=273,
                          "max_bin"=73,
                          "lambda_l1"=73.03555613,
                          "lambda_l2"=43.95354363,
                          "ratio_corte"=0.04088524014
                        )
