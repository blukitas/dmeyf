...
param_ganadores  <- list( "learning_rate"=0.047088726448801, 
                          "feature_fraction"= 0.701615598991884,
                          "bagging_fraction"= 0.930140893,
                          "bagging_freq"= 62,
                          "min_gain_to_split" =1.8872982954223500,
                          "min_data_in_leaf"= 21,
                          "num_leaves"= 178,
                          "max_bin"=25,
                          "lambda_l1"=73.89124616,
                          "lambda_l2"=35.00370753,
                          "ratio_corte"=0.03892696643
                        )
