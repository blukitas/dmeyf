...
# TODO: Probar el nuevas variables
...
AgregarMes  <- function( dataset )
{
  ...
  cat(paste0("Agregar: Foto_mes_", dataset[1, "foto_mes"][1]), "\n" )
...
correr_todo  <- function( palancas )
{
  ...
  # TODO: Test para desde y hasta, con pocos registros para test local
  # INICIO
  # dataset  <- fread( "./datasetsOri/paquete_premium.csv.gz", nrows=50)
  # FIN
