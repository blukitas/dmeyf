...
kscript         <- "1084_138_epic"
karch_dataset   <- "./datasets/dataset_epic_v1054.csv.gz"  #el dataset que voy a utilizar
...
param_ganadores  <- list( "learning_rate"=0.03357238400148250, 
                          "feature_fraction"=0.49576630454741600,
                          "bagging_fraction"=0.85342007677924600,
                          "bagging_freq"=53,
                          "min_gain_to_split"=10.2749325697666000,                          
                          "min_data_in_leaf"= 2349,
                          "num_leaves"= 498,
                          "max_bin"=191,
                          "lambda_l1"=8.08014246205757000,
                          "lambda_l2"=12.71155186984310000,
                          "num_iterations"=329,
                          "ratio_corte"= 0.03302518503591570
                        )
