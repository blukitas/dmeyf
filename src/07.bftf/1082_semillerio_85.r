...
param_ganadores  <- list( "learning_rate"=0.046544210807614, 
                          "feature_fraction"=0.677688945406173,
                          "bagging_fraction"=0.903984885855931,
                          "bagging_freq"= 53,
                          "min_gain_to_split" =13.123210442811600,
                          "min_data_in_leaf"=461,
                          "num_leaves"=854,
                          "max_bin"=67,
                          "lambda_l1"=74.606610044371300,
                          "lambda_l2"=52.562119643081700,
                          "ratio_corte"=0.0357133890688157
                        )
