...
kscript         <- "1083_105_epic"
karch_dataset   <- "./datasets/dataset_epic_v1053.csv.gz"  #el dataset que voy a utilizar
...
kgen_mes_desde   <- 202001  #desde donde voy a entrenar
...
param_ganadores  <- list( "learning_rate"= 0.07249963708306360, 
                          "feature_fraction"=0.22417190905137500,
                          "bagging_fraction"=0.83456438848959700,
                          "bagging_freq"=52,
                          "min_gain_to_split"=0.6785598959464980,                          
                          "min_data_in_leaf"= 2491,
                          "num_leaves"= 122,
                          "max_bin"=223,
                          "lambda_l1"=55.53538152310190000,
                          "lambda_l2"=14.02373319511670000,
                          "num_iterations"=193,
                          "ratio_corte"= 0.03857521295398350
                        )
