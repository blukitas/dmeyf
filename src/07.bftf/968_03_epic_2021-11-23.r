...
karch_dataset    <- "./datasets/dataset_epic_v1054.csv.gz"
...
# TODO: Cambiar mes de inicio
ktrain_mes_desde    <- 202001
# TODO: Hay otos meses muy malos?
...
# ksemilla_azar  <- 1021917
# Semillas que elegí: 
#   135221, 355847, 646577, 772921, 975257
ksemilla_azar  <- 646577  #Aqui poner la propia semilla
#------------------------------------------------------------------------------
