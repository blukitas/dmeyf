...
param_ganadores  <- list( "learning_rate"=0.098623052476905, 
                          "feature_fraction"=0.819128756229184,
                          "bagging_fraction"=0.880011681530159,
                          "bagging_freq"= 17,
                          "min_gain_to_split" =13.882645518664500,
                          "min_data_in_leaf"=1987,
                          "num_leaves"=604,
                          "max_bin"=87,
                          "lambda_l1"=91.641028283047500,
                          "lambda_l2"=87.982090429868500,
                          "ratio_corte"=0.0457976617877198
                        )
