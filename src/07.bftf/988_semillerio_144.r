...
param_ganadores  <- list( "learning_rate"=0.057654368872015, 
                          "feature_fraction"= 0.624662727945359,
                          "bagging_fraction"= 0.9335938922,
                          "bagging_freq"= 37,
                          "min_gain_to_split" =2.1312537203402500,
                          "min_data_in_leaf"= 58,
                          "num_leaves"= 397,
                          "max_bin"=42,
                          "lambda_l1"=33.31953017, 
                          "lambda_l2"=75.92696799,
                          "ratio_corte"=0.04583113655
                        )
