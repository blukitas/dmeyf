...
param_ganadores  <- list( "learning_rate"=0.021509627905784, 
                          "feature_fraction"=0.762531451562649,
                          "bagging_fraction"=0.925573402667352,
                          "bagging_freq"=46,
                          "min_gain_to_split"=9.771863072840860,
                          "min_data_in_leaf"=63,
                          "num_leaves"=933,
                          "max_bin"=74,
                          "lambda_l1"=89.067261992129700,
                          "lambda_l2"=18.893951248525600,
                          "ratio_corte"=0.0383160519863088
                        )
