...
param_ganadores  <- list( "learning_rate"= 0.04577469913112990, 
                          "feature_fraction"=0.34290493259064000,
                          "bagging_fraction"=0.65961497587992800,
                          "bagging_freq"=6,
                          "min_gain_to_split"=2.0433560495315200,                          
                          "min_data_in_leaf"= 625,
                          "num_leaves"= 552,
                          "max_bin"=49,
                          "lambda_l1"=65.90144058422130000,
                          "lambda_l2"=26.61858081468530000,
                          "num_iterations"= 73,
                          "ratio_corte"= 0.04534691872693610
                        )
