...
param_ganadores  <- list( "learning_rate"= 0.02625717337302050, 
                          "feature_fraction"=0.22499574518704300,
                          "bagging_fraction"=0.83195353784786400,
                          "bagging_freq"=11,
                          "min_gain_to_split"=1.1142599690328400,                          
                          "min_data_in_leaf"= 554,
                          "num_leaves"= 304,
                          "max_bin"=119,
                          "lambda_l1"=70.25366998904640000,
                          "lambda_l2"=19.82526380244680000,
                          "num_iterations"=364,
                          "ratio_corte"= 0.04085903684765130
                        )
