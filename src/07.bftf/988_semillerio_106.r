...
param_ganadores  <- list( "learning_rate"=0.039280937434338, 
                          "feature_fraction"= 0.677447404742969,
                          "bagging_fraction"= 0.9334796663,
                          "bagging_freq"= 84,
                          "min_gain_to_split"=3.3681436056853300,
                          "min_data_in_leaf"=125,
                          "num_leaves"=826,
                          "max_bin"=70,
                          "lambda_l1"=57.00660033,
                          "lambda_l2"=62.4304058,
                          "ratio_corte"=0.04104424527
                        )
