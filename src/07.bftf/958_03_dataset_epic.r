...
palancas$version  <- "v1054"   #Muy importante, ir cambiando la version
...
DeflactarDataset <- function( dataset )
{
  cat("Deflactar dataset")
...
DolarizarDataset <- function( dataset )
{
...
if( palancas$antonio )  Antonio( cols_analiticas)
  ...
  if( palancas$dolarizar )  DolarizarDataset( dataset)
