...
param_ganadores  <- list( "learning_rate"=0.04204378512, 
                          "feature_fraction"= 0.3229386684,
                          "bagging_fraction"= 0.9593284105,
                          "bagging_freq"= 73,
                          "min_gain_to_split"=2.124362241,
                          "min_data_in_leaf"= 40,
                          "num_leaves"= 228,
                          "max_bin"=72,
                          "lambda_l1"=76.0883095,
                          "lambda_l2"=54.34804712,
                          "ratio_corte"=0.04141246768
                        )
