...
param_ganadores  <- list( "learning_rate"=0.046509281021605, 
                          "feature_fraction"= 0.812976637799418,
                          "bagging_fraction"= 0.9604642825,
                          "bagging_freq"= 34,
                          "min_gain_to_split"=2.4226535307908100,
                          "min_data_in_leaf"=21,
                          "num_leaves"=185,
                          "max_bin"=31,
                          "lambda_l1"=44.98063413,
                          "lambda_l2"=34.32045758,
                          "ratio_corte"=0.03424049944
                        )
