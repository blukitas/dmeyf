...
kscript         <- "987_61_epic"
karch_dataset   <- "./datasets/dataset_epic_v957.csv.gz"  #el dataset que voy a utilizar
...
param_ganadores  <- list( "learning_rate"= 0.076959334372394, 
                          "feature_fraction"= 0.202459480938455,
                          "min_data_in_leaf"= 4644,
                          "num_leaves"= 217,
                          "num_iterations"= 476,
                          "ratio_corte"= 0.0367343693772857
                        )
