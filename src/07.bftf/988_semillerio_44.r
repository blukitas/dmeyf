...
param_ganadores  <- list( "learning_rate"=0.059574768156580, 
                          "feature_fraction"= 0.984076948423775,
                          "bagging_fraction"= 0.9116736619,
                          "bagging_freq"= 3,
                          "min_gain_to_split" =4.3924219053540800,
                          "min_data_in_leaf"= 41,
                          "num_leaves"= 340,
                          "max_bin"=56,
                          "lambda_l1"=6.259687578,
                          "lambda_l2"=49.22230281,
                          "ratio_corte"=0.03749592026
                        )
