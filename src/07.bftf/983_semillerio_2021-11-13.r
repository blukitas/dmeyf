...
kscript         <- "983_epic"
karch_dataset   <- "./datasets/dataset_epic_v953.csv.gz"  #el dataset que voy a utilizar
...
param_ganadores  <- list( "learning_rate"= 0.069741993886940, 
                          "feature_fraction"= 0.427681592786498,
                          "min_data_in_leaf"= 466,
                          "num_leaves"= 679,
                          "num_iterations"= 95,
                          "ratio_corte"= 0.0398140476848016
                        )
